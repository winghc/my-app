#https://git.centos.org/rpms/java-1.7.0-openjdk/raw/bd5290b00c7126d56f818e225c33602e8452f429/f/SPECS/java-1.7.0-openjdk.spec
...
* Sun Jul 22 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.191-2.6.15.5
- Bump to revised 2.6.15 tarball with PR3616 -notimestamp javadoc fix
- Resolves: rhbz#1594249

* Thu Jul 19 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.191-2.6.15.4
- Bump to revised 2.6.15 tarball with jdk7u191-b01
- Resolves: rhbz#1594249

* Mon Jul 16 2018 Severin Gehwolf <sgehwolf@redhat.com> - 1:1.7.0.191-2.6.15.3
...
* Wed Jul 11 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.191-2.6.15.2
- Bump to revised 2.6.15 tarball with PR3604
- Resolves: rhbz#1594249

* Tue Jul 03 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.191-2.6.15.1
- Bump to 2.6.15 and u191b00.
- Drop PR3608/RH1566890/CVE-2018-3639 patch now applied upstream.
- Resolves: rhbz#1594249

* Tue Jul 03 2018 Severin Gehwolf <sgehwolf@redhat.com> - 1:1.7.0.181-2.6.14.11
- Add hook to show hs_err*.log files on failures.
- Resolves: rhbz#1594249

* Tue Jul 03 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.181-2.6.14.11
- Cleanup RH1566890 patch and differentiate from java-1.8.0-openjdk version.
- Resolves: rhbz#1594249

* Wed Jun 20 2018 Jiri Vanek <jvanek@redhat.com> - 1:1.7.0.181-2.6.14.11
- jsa files changed to 444 to pass rpm verification
- Add reg-ex for filtering private libraries' provides/requires.
- Resolves: rhbz#1594249

* Tue May 22 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.181-2.6.14.10
- Fix patch files to appease git apply --stat
- Resolves: rhbz#1578561

* Thu Apr 26 2018 Jiri Vanek <jvanek@redhat.com> - 1:1.7.0.181-2.6.14.9
- added and applied 1566890_embargoed20180521.patch
- Resolves: rhbz#1578561

* Thu Apr 26 2018 Jiri Vanek <jvanek@redhat.com> - 1:1.7.0.181-2.6.14.6
- added depndence on latest c-j-c who do not have the incorrect jre-abrt handling
- Resolves: rhbz#1559766

* Fri Apr 20 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.181-2.6.14.4
- Bump release so RHEL 7.6 version is higher than RHEL 7.5.z.
- Resolves: rhbz#1559766

* Fri Apr 20 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.181-2.6.14.2
- Fix invalid license 'LGPL+' (should be LGPLv2+ for ECC code) and add missing ones
- Resolves: rhbz#1559766

* Thu Apr 19 2018 Andrew Hughes <gnu.andrew@redhat.com> - 1:1.7.0.181-2.6.14.1
